...
- [x] **S001** Create environment configuration file `.env.example` with required variables
...
- [x] **S002** Install npm dependencies for wiki integration
...
- [x] **S003** Create `/scripts/` directory structure and config files
...
- [x] **S004** [P] Create TypeScript type definitions for wiki data
...
- [x] **S005** [P] Update package.json with new build scripts
...
- [x] **S006** Create JSON schema for Faction validation (`scripts/schemas/faction.schema.json`)
...
- [x] **S007** [P] Create JSON schema for Biome validation (`scripts/schemas/biome.schema.json`)
...
- [x] **S008** Create validation script (`scripts/validate-data.mjs`)
...
- [x] **S009** [P] Create style-dictionary configuration (`style-dictionary.config.js`)
...
- [x] **S010** Test validation with existing JSON files
...
- [x] **S011** Create wiki fetch script (`scripts/fetch-wiki-data.mjs`)
...
- [x] **S012** Implement wiki page fetching logic in fetch-wiki-data.mjs
...
- [x] **S013** Add error handling to fetch-wiki-data.mjs
...
- [x] **S014** [P] Create wiki content cache mechanism
...
- [x] **S015** Test wiki fetching script
...
- [x] **S016** Create transformation script (`scripts/transform-wiki-to-json.mjs`)
...
- [x] **S017** Implement markdown table parser for faction data
...
- [x] **S018** Implement faction data transformation logic
...
- [x] **S019** Write transformed data to JSON files
...
- [x] **S020** Test transformation script
...
- [x] **S021** Create design token extraction script (`scripts/extract-design-tokens.mjs`)
...
- [x] **S022** Implement color palette extraction
...
- [x] **S023** [P] Implement typography extraction
...
- [x] **S024** Generate style-dictionary output
...
- [x] **S025** Test design token extraction
...
- [x] **S026** Create audit script (`scripts/audit-content.mjs`)
...
- [x] **S027** Implement comparison logic
...
- [x] **S029** Implement exit code logic for CI/CD
...
- [x] **S031** Update .github/workflows files for wiki sync
  ...
  - **NOTE**: Manual GitHub Secrets setup required by user

- [x] **S032** [P] Create npm script for local development
  ...
  - **COMPLETED**: Scripts already added in S005

- [x] **S033** Write integration test script (`scripts/test-pipeline.mjs`)
...
- [x] **S034** Run end-to-end pipeline test
...
- [x] **S035** Final verification and documentation
